...
class MyWindow(QWidget):
    def __init__(self):
        ...
        self.layout1.addWidget(self.buttonMinus)

        self.buttonTimes = QPushButton('*')
        self.buttonTimes.clicked.connect(self.actionTimes)
        self.layout1.addWidget(self.buttonTimes)

        self.buttonDiv = QPushButton('/')
        self.buttonDiv.clicked.connect(self.actionDiv)
        self.layout1.addWidget(self.buttonDiv)
